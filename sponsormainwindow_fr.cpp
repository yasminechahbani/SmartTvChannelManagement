...
SponsorMainWindowFr::SponsorMainWindowFr(QWidget *parent)
    : QMainWindow(parent)
    , ui(new Ui::SponsorMainWindowFr)
{
    ui->setupUi(this);
...
void SponsorMainWindowFr::on_sendButton_clicked()
{
...
void SponsorMainWindowFr::on_tableHeader_clicked(int index)
{
    // Sort the table based on the clicked column
    ui->sponsor_tab->sortByColumn(index, Qt::AscendingOrder);
}

void SponsorMainWindowFr::on_eng_clicked()
{
this->close();
    SponsorMainWindow *newwindow= new SponsorMainWindow(this);
    newwindow->show();
...
SponsorMainWindowFr::~SponsorMainWindowFr()
{
    delete ui;
}
...
void SponsorMainWindowFr::on_ajouter_clicked()
{
...
void SponsorMainWindowFr::on_delete_button_clicked()
{
...
void SponsorMainWindowFr::on_list_all_button_clicked()
{
      //with search
      ui->sponsor_tab->setModel(sponsor.showSponsor());
...
void SponsorMainWindowFr::on_search_clicked()
{
    //ui->sponsor_tab->setModel(sponsor.showSponsor());
...
void SponsorMainWindowFr::on_clear_fields_add_clicked()
{
...
void SponsorMainWindowFr::on_clear_all_in_table_clicked()
{
...
void SponsorMainWindowFr::on_update_clicked()
{
...
void SponsorMainWindowFr::on_Generate_PDF_clicked()
{
...
void SponsorMainWindowFr::on_stat_clicked()
{
    Sponsor sponsor;
...
void SponsorMainWindowFr::on_checkContracts_clicked()
{
    Sponsor sponsor;
...
void SponsorMainWindowFr::on_Sponsor_tabHeader_clicked(int index)
{
    // Sort the table based on the clicked column
    ui->sponsor_tab->sortByColumn(index, Qt::AscendingOrder);
}
...
void SponsorMainWindowFr::on_use_return_clicked()
{
...
void SponsorMainWindowFr::onSendSMSButtonClicked()
{
   /* Sponsor sponsor;
...
void SponsorMainWindowFr::on_excel_clicked() {
...
void SponsorMainWindowFr::on_sort_clicked()
{
...
void SponsorMainWindowFr::on_sms_clicked()
{
...
void SponsorMainWindowFr::sendSMS(const QString& recipient, const QString& message)
{
    QNetworkAccessManager* manager = new QNetworkAccessManager(this);
    connect(manager, &QNetworkAccessManager::finished, this, &SponsorMainWindowFr::onSMSRequestFinished);
...
void SponsorMainWindowFr::onSMSRequestFinished(QNetworkReply* reply)
{
    if (reply->error() == QNetworkReply::NoError) {
