#ifndef SPONSORMAINWINDOW_FR_H
#define SPONSORMAINWINDOW_FR_H
...
QT_BEGIN_NAMESPACE
namespace Ui { class SponsorMainWindowFr; }
QT_END_NAMESPACE

class SponsorMainWindowFr : public QMainWindow
{
    Q_OBJECT

public:
    SponsorMainWindowFr(QWidget *parent = nullptr);
    ~SponsorMainWindowFr();
...
private:
    QTime startTime;
    QTime endTime;
    Ui::SponsorMainWindowFr *ui;
    Sponsor sponsor; // Instantiate the Sponsor class
};



#endif // SPONSORMAINWINDOW_FR_H
