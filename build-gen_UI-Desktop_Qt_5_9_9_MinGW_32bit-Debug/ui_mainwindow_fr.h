/********************************************************************************
** Form generated from reading UI file 'mainwindow_fr.ui'
**
...
#ifndef UI_MAINWINDOW_FR_H
#define UI_MAINWINDOW_FR_H
...
public:
    ...
    void setupUi(QMainWindow *MainWindowFr)
    {
        if (MainWindowFr->objectName().isEmpty())
            MainWindowFr->setObjectName(QStringLiteral("MainWindowFr"));
        MainWindowFr->resize(1753, 969);
        MainWindowFr->setStyleSheet(QLatin1String("QMainWindow {\n"
"    background: white;\n"
"}"));
        centralwidget = new QWidget(MainWindowFr);
...
""));
        ...
        pushButton_7->raise();
        label_13->raise();
        MainWindowFr->setCentralWidget(centralwidget);
        menubar = new QMenuBar(MainWindowFr);
        ...
        MainWindowFr->setMenuBar(menubar);
        statusbar = new QStatusBar(MainWindowFr);
        statusbar->setObjectName(QStringLiteral("statusbar"));
        MainWindowFr->setStatusBar(statusbar);
        ...
        retranslateUi(MainWindowFr);

        tabWidget->setCurrentIndex(5);


        QMetaObject::connectSlotsByName(MainWindowFr);
    } // setupUi

    void retranslateUi(QMainWindow *MainWindowFr)
    {
        MainWindowFr->setWindowTitle(QApplication::translate("MainWindowFr", "MainWindow", Q_NULLPTR));
        pushButton->setText(QApplication::translate("MainWindowFr", "Sponsors", Q_NULLPTR));
        label_10->setText(QApplication::translate("MainWindowFr", "emissions", Q_NULLPTR));
        label_12->setText(QApplication::translate("MainWindowFr", "          Equipement", Q_NULLPTR));
        label_11->setText(QApplication::translate("MainWindowFr", "invites", Q_NULLPTR));
        label_5->setText(QString());
        label_3->setText(QApplication::translate("MainWindowFr", "TextLabel", Q_NULLPTR));
        search->setText(QString());
        search_lineEdit->setText(QString());
        search_lineEdit->setPlaceholderText(QApplication::translate("MainWindowFr", "votre recherche ici ", Q_NULLPTR));
        toolButton_2->setText(QApplication::translate("MainWindowFr", "filtre", Q_NULLPTR));
        label_15->setText(QString());
        add_button->setText(QApplication::translate("MainWindowFr", "    Ajouter Sponsor", Q_NULLPTR));
        Generate_PDF->setText(QApplication::translate("MainWindowFr", "   generer pdf", Q_NULLPTR));
        label_9->setText(QString());
        pushButton_2->setText(QApplication::translate("MainWindowFr", "Liste des Sponsors", Q_NULLPTR));
        stat->setText(QApplication::translate("MainWindowFr", "Statistiques", Q_NULLPTR));
        label_14->setText(QString());
        label_16->setText(QString());
        label_8->setText(QString());
        label_20->setText(QApplication::translate("MainWindowFr", "TextLabel", Q_NULLPTR));
        label_21->setText(QString());
        label_22->setText(QApplication::translate("MainWindowFr", "TextLabel", Q_NULLPTR));
        label_23->setText(QString());
        label_24->setText(QApplication::translate("MainWindowFr", "TextLabel", Q_NULLPTR));
        label_25->setText(QString());
        label_26->setText(QApplication::translate("MainWindowFr", "TextLabel", Q_NULLPTR));
        label_27->setText(QString());
        label_28->setText(QString());
        label_18->setText(QString());
        sort->setText(QApplication::translate("MainWindowFr", "tri", Q_NULLPTR));
        label_19->setText(QApplication::translate("MainWindowFr", "ID", Q_NULLPTR));
        label_29->setText(QApplication::translate("MainWindowFr", "nom", Q_NULLPTR));
        label_30->setText(QApplication::translate("MainWindowFr", "montant", Q_NULLPTR));
        label_31->setText(QApplication::translate("MainWindowFr", "temps d'affichage", Q_NULLPTR));
        label_32->setText(QApplication::translate("MainWindowFr", "etat contrat", Q_NULLPTR));
        label_34->setText(QApplication::translate("MainWindowFr", "employee_id", Q_NULLPTR));
        ajouter->setText(QApplication::translate("MainWindowFr", "ajouter", Q_NULLPTR));
        clear_fields_add->setText(QApplication::translate("MainWindowFr", "clear", Q_NULLPTR));
        name_lineEdit->setText(QString());
        name_lineEdit->setPlaceholderText(QApplication::translate("MainWindowFr", "type here", Q_NULLPTR));
        id_lineEdit->setText(QString());
        id_lineEdit->setPlaceholderText(QApplication::translate("MainWindowFr", "type here", Q_NULLPTR));
        montant_lineEdit->setText(QString());
        montant_lineEdit->setPlaceholderText(QApplication::translate("MainWindowFr", "type here", Q_NULLPTR));
        employee_id_lineEdit->setText(QApplication::translate("MainWindowFr", "021dd", Q_NULLPTR));
        tempsaffichage_lineEdit->setText(QString());
        tempsaffichage_lineEdit->setPlaceholderText(QApplication::translate("MainWindowFr", "type here", Q_NULLPTR));
        etatcontrat_lineEdit->setText(QString());
        etatcontrat_lineEdit->setPlaceholderText(QApplication::translate("MainWindowFr", "type here", Q_NULLPTR));
        nb_totalaffichage_lineEdit->setText(QString());
        nb_totalaffichage_lineEdit->setPlaceholderText(QApplication::translate("MainWindowFr", "type here", Q_NULLPTR));
        label_37->setText(QApplication::translate("MainWindowFr", "nb total affichage", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("MainWindowFr", "ajouter", Q_NULLPTR));
        emailLineEdit->setText(QString());
        emailLineEdit->setPlaceholderText(QApplication::translate("MainWindowFr", "ecrire ici", Q_NULLPTR));
        passwordLineEdit->setText(QString());
        passwordLineEdit->setPlaceholderText(QApplication::translate("MainWindowFr", "ecrire ici", Q_NULLPTR));
        label_43->setText(QApplication::translate("MainWindowFr", "Email :", Q_NULLPTR));
        label_44->setText(QApplication::translate("MainWindowFr", "mot de passe", Q_NULLPTR));
        label_45->setText(QApplication::translate("MainWindowFr", "Recepient :", Q_NULLPTR));
        label_46->setText(QApplication::translate("MainWindowFr", "contenu", Q_NULLPTR));
        recipientLineEdit->setText(QString());
        recipientLineEdit->setPlaceholderText(QApplication::translate("MainWindowFr", "ecrire ici", Q_NULLPTR));
        contentTextEdit->setText(QString());
        contentTextEdit->setPlaceholderText(QApplication::translate("MainWindowFr", "ecrire ici", Q_NULLPTR));
        label_47->setText(QApplication::translate("MainWindowFr", "sujet", Q_NULLPTR));
        subjectLineEdit->setText(QString());
        subjectLineEdit->setPlaceholderText(QApplication::translate("MainWindowFr", "ecrire ici", Q_NULLPTR));
        sendButton->setText(QApplication::translate("MainWindowFr", "envoyer", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_5), QApplication::translate("MainWindowFr", "Envoyer Mail", Q_NULLPTR));
        update->setText(QApplication::translate("MainWindowFr", "Update", Q_NULLPTR));
        etatcontrat_lineEdit_2->setText(QApplication::translate("MainWindowFr", "type here", Q_NULLPTR));
        label_33->setText(QApplication::translate("MainWindowFr", "temps d'affichage", Q_NULLPTR));
        label_39->setText(QApplication::translate("MainWindowFr", "nb total affichage", Q_NULLPTR));
        label_36->setText(QApplication::translate("MainWindowFr", "ID", Q_NULLPTR));
        montant_lineEdit_2->setText(QApplication::translate("MainWindowFr", "type here", Q_NULLPTR));
        label_40->setText(QApplication::translate("MainWindowFr", "etat contrat", Q_NULLPTR));
        label_41->setText(QApplication::translate("MainWindowFr", "nom", Q_NULLPTR));
        tempsaffichage_lineEdit_2->setText(QApplication::translate("MainWindowFr", "type here", Q_NULLPTR));
        name_lineEdit_2->setText(QApplication::translate("MainWindowFr", "type here", Q_NULLPTR));
        label_42->setText(QApplication::translate("MainWindowFr", "montant", Q_NULLPTR));
        nb_totalaffichage_lineEdit_2->setText(QApplication::translate("MainWindowFr", "type here", Q_NULLPTR));
        id_lineEdit_2->setText(QApplication::translate("MainWindowFr", "type here", Q_NULLPTR));
        ajouter_2->setText(QApplication::translate("MainWindowFr", "Ajouter", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_4), QApplication::translate("MainWindowFr", "Mise a ajour", Q_NULLPTR));
        label_35->setText(QApplication::translate("MainWindowFr", "ID", Q_NULLPTR));
        id_lineEdit_delete->setText(QApplication::translate("MainWindowFr", "ecrire ici", Q_NULLPTR));
        delete_button->setText(QApplication::translate("MainWindowFr", "Delete", Q_NULLPTR));
        label_38->setText(QApplication::translate("MainWindowFr", "taper l'id de sponsor", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("MainWindowFr", "Supprimer", Q_NULLPTR));
        clear_all_in_table->setText(QApplication::translate("MainWindowFr", "supprimer tout les sponsors", Q_NULLPTR));
        list_all_button->setText(QApplication::translate("MainWindowFr", "sponsor list", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("MainWindowFr", "affichage", Q_NULLPTR));
        label_48->setText(QApplication::translate("MainWindowFr", "debut", Q_NULLPTR));
        label_49->setText(QApplication::translate("MainWindowFr", "fin", Q_NULLPTR));
        SendButton->setText(QApplication::translate("MainWindowFr", "sauvegarder", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_16), QApplication::translate("MainWindowFr", "Calendrier", Q_NULLPTR));
        jgcugedu->setText(QApplication::translate("MainWindowFr", "contrats", Q_NULLPTR));
        sms->setText(QApplication::translate("MainWindowFr", "envoyer sms", Q_NULLPTR));
        excel->setText(QApplication::translate("MainWindowFr", "Generer excel", Q_NULLPTR));
        sortComboBox->clear();
        sortComboBox->insertItems(0, QStringList()
         << QApplication::translate("MainWindowFr", "default", Q_NULLPTR)
         << QApplication::translate("MainWindowFr", "A-Z", Q_NULLPTR)
        );
        eng->setText(QApplication::translate("MainWindowFr", "ENG", Q_NULLPTR));
        ...
        pushButton_7->setText(QApplication::translate("MainWindowFr", "se deconnecter", Q_NULLPTR));
        label_13->setText(QApplication::translate("MainWindowFr", "Employees", Q_NULLPTR));
        menuCreate->setTitle(QApplication::translate("MainWindowFr", "Create ", Q_NULLPTR));
        menuRead->setTitle(QApplication::translate("MainWindowFr", "Read", Q_NULLPTR));
        menuupdate->setTitle(QApplication::translate("MainWindowFr", "Update", Q_NULLPTR));
        menudelete->setTitle(QApplication::translate("MainWindowFr", "Delete ", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class MainWindowFr: public Ui_MainWindowFr {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_MAINWINDOW_FR_H
