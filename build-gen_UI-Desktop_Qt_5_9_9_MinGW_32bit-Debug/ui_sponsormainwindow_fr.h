/********************************************************************************
** Form generated from reading UI file 'sponsormainwindow_fr.ui'
**
...
#ifndef UI_SPONSORMAINWINDOW_FR_H
#define UI_SPONSORMAINWINDOW_FR_H
...
public:
    ...
    void setupUi(QMainWindow *SponsorMainWindowFr)
    {
        if (SponsorMainWindowFr->objectName().isEmpty())
            SponsorMainWindowFr->setObjectName(QStringLiteral("SponsorMainWindowFr"));
        SponsorMainWindowFr->resize(1753, 969);
        SponsorMainWindowFr->setStyleSheet(QLatin1String("QMainWindow {\n"
"    background: white;\n"
"}"));
        centralwidget = new QWidget(SponsorMainWindowFr);
...
""));
        ...
        label_10->setGeometry(QRect(120, 230, 300, 60));
        QPalette palette;
...
"font: 75 12pt \"8514oem\";"));
        ...
        label_11->setGeometry(QRect(120, 310, 300, 60));
        QPalette palette2;
...
""));
        ...
        label_49->setGeometry(QRect(60, 129, 41, 21));
...
""));
        eng = new QPushButton(frame_3);
        eng->setObjectName(QStringLiteral("eng"));
        eng->setGeometry(QRect(540, 190, 131, 51));
        eng->setCursor(QCursor(Qt::PointingHandCursor));
        eng->setStyleSheet(QLatin1String("\n"
"    QPushButton {\n"
"        background-color: #3F88C5;\n"
"        border: none;\n"
"        color: white;\n"
...
"border:0px;"));
        ...
        pushButton_7->setGeometry(QRect(124, 720, 161, 28));
...
""));
        ...
        pushButton_7->raise();
        label_13->raise();
        SponsorMainWindowFr->setCentralWidget(centralwidget);
        menubar = new QMenuBar(SponsorMainWindowFr);
        ...
        SponsorMainWindowFr->setMenuBar(menubar);
        statusbar = new QStatusBar(SponsorMainWindowFr);
        statusbar->setObjectName(QStringLiteral("statusbar"));
        SponsorMainWindowFr->setStatusBar(statusbar);
        ...
        retranslateUi(SponsorMainWindowFr);

        tabWidget->setCurrentIndex(5);


        QMetaObject::connectSlotsByName(SponsorMainWindowFr);
    } // setupUi

    void retranslateUi(QMainWindow *SponsorMainWindowFr)
    {
        SponsorMainWindowFr->setWindowTitle(QApplication::translate("SponsorMainWindowFr", "MainWindow", Q_NULLPTR));
        pushButton->setText(QApplication::translate("SponsorMainWindowFr", "Sponsors", Q_NULLPTR));
        label_10->setText(QApplication::translate("SponsorMainWindowFr", "emissions", Q_NULLPTR));
        label_12->setText(QApplication::translate("SponsorMainWindowFr", "          Equipement", Q_NULLPTR));
        label_11->setText(QApplication::translate("SponsorMainWindowFr", "invites", Q_NULLPTR));
        label_5->setText(QString());
        label_3->setText(QApplication::translate("SponsorMainWindowFr", "TextLabel", Q_NULLPTR));
        search->setText(QString());
        search_lineEdit->setText(QString());
        search_lineEdit->setPlaceholderText(QApplication::translate("SponsorMainWindowFr", "votre recherche ici ", Q_NULLPTR));
        toolButton_2->setText(QApplication::translate("SponsorMainWindowFr", "filtre", Q_NULLPTR));
        label_15->setText(QString());
        add_button->setText(QApplication::translate("SponsorMainWindowFr", "    Ajouter Sponsor", Q_NULLPTR));
        Generate_PDF->setText(QApplication::translate("SponsorMainWindowFr", "   generer pdf", Q_NULLPTR));
        label_9->setText(QString());
        pushButton_2->setText(QApplication::translate("SponsorMainWindowFr", "Liste des Sponsors", Q_NULLPTR));
        stat->setText(QApplication::translate("SponsorMainWindowFr", "Statistiques", Q_NULLPTR));
        label_14->setText(QString());
        label_16->setText(QString());
        label_8->setText(QString());
        label_20->setText(QApplication::translate("SponsorMainWindowFr", "TextLabel", Q_NULLPTR));
        label_21->setText(QString());
        label_22->setText(QApplication::translate("SponsorMainWindowFr", "TextLabel", Q_NULLPTR));
        label_23->setText(QString());
        label_24->setText(QApplication::translate("SponsorMainWindowFr", "TextLabel", Q_NULLPTR));
        label_25->setText(QString());
        label_26->setText(QApplication::translate("SponsorMainWindowFr", "TextLabel", Q_NULLPTR));
        label_27->setText(QString());
        label_28->setText(QString());
        label_18->setText(QString());
        sort->setText(QApplication::translate("SponsorMainWindowFr", "tri", Q_NULLPTR));
        label_19->setText(QApplication::translate("SponsorMainWindowFr", "ID", Q_NULLPTR));
        label_29->setText(QApplication::translate("SponsorMainWindowFr", "nom", Q_NULLPTR));
        label_30->setText(QApplication::translate("SponsorMainWindowFr", "montant", Q_NULLPTR));
        label_31->setText(QApplication::translate("SponsorMainWindowFr", "temps d'affichage", Q_NULLPTR));
        label_32->setText(QApplication::translate("SponsorMainWindowFr", "etat contrat", Q_NULLPTR));
        label_34->setText(QApplication::translate("SponsorMainWindowFr", "employee_id", Q_NULLPTR));
        ajouter->setText(QApplication::translate("SponsorMainWindowFr", "ajouter", Q_NULLPTR));
        clear_fields_add->setText(QApplication::translate("SponsorMainWindowFr", "clear", Q_NULLPTR));
        name_lineEdit->setText(QString());
        name_lineEdit->setPlaceholderText(QApplication::translate("SponsorMainWindowFr", "type here", Q_NULLPTR));
        id_lineEdit->setText(QString());
        id_lineEdit->setPlaceholderText(QApplication::translate("SponsorMainWindowFr", "type here", Q_NULLPTR));
        montant_lineEdit->setText(QString());
        montant_lineEdit->setPlaceholderText(QApplication::translate("SponsorMainWindowFr", "type here", Q_NULLPTR));
        employee_id_lineEdit->setText(QApplication::translate("SponsorMainWindowFr", "021dd", Q_NULLPTR));
        tempsaffichage_lineEdit->setText(QString());
        tempsaffichage_lineEdit->setPlaceholderText(QApplication::translate("SponsorMainWindowFr", "type here", Q_NULLPTR));
        etatcontrat_lineEdit->setText(QString());
        etatcontrat_lineEdit->setPlaceholderText(QApplication::translate("SponsorMainWindowFr", "type here", Q_NULLPTR));
        nb_totalaffichage_lineEdit->setText(QString());
        nb_totalaffichage_lineEdit->setPlaceholderText(QApplication::translate("SponsorMainWindowFr", "type here", Q_NULLPTR));
        label_37->setText(QApplication::translate("SponsorMainWindowFr", "nb total affichage", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("SponsorMainWindowFr", "ajouter", Q_NULLPTR));
        emailLineEdit->setText(QString());
        emailLineEdit->setPlaceholderText(QApplication::translate("SponsorMainWindowFr", "ecrire ici", Q_NULLPTR));
        passwordLineEdit->setText(QString());
        passwordLineEdit->setPlaceholderText(QApplication::translate("SponsorMainWindowFr", "ecrire ici", Q_NULLPTR));
        label_43->setText(QApplication::translate("SponsorMainWindowFr", "Email :", Q_NULLPTR));
        label_44->setText(QApplication::translate("SponsorMainWindowFr", "mot de passe", Q_NULLPTR));
        label_45->setText(QApplication::translate("SponsorMainWindowFr", "Recepient :", Q_NULLPTR));
        label_46->setText(QApplication::translate("SponsorMainWindowFr", "contenu", Q_NULLPTR));
        recipientLineEdit->setText(QString());
        recipientLineEdit->setPlaceholderText(QApplication::translate("SponsorMainWindowFr", "ecrire ici", Q_NULLPTR));
        contentTextEdit->setText(QString());
        contentTextEdit->setPlaceholderText(QApplication::translate("SponsorMainWindowFr", "ecrire ici", Q_NULLPTR));
        label_47->setText(QApplication::translate("SponsorMainWindowFr", "sujet", Q_NULLPTR));
        subjectLineEdit->setText(QString());
        subjectLineEdit->setPlaceholderText(QApplication::translate("SponsorMainWindowFr", "ecrire ici", Q_NULLPTR));
        sendButton->setText(QApplication::translate("SponsorMainWindowFr", "envoyer", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_5), QApplication::translate("SponsorMainWindowFr", "Envoyer Mail", Q_NULLPTR));
        update->setText(QApplication::translate("SponsorMainWindowFr", "Update", Q_NULLPTR));
        etatcontrat_lineEdit_2->setText(QApplication::translate("SponsorMainWindowFr", "type here", Q_NULLPTR));
        label_33->setText(QApplication::translate("SponsorMainWindowFr", "temps d'affichage", Q_NULLPTR));
        label_39->setText(QApplication::translate("SponsorMainWindowFr", "nb total affichage", Q_NULLPTR));
        label_36->setText(QApplication::translate("SponsorMainWindowFr", "ID", Q_NULLPTR));
        montant_lineEdit_2->setText(QApplication::translate("SponsorMainWindowFr", "type here", Q_NULLPTR));
        label_40->setText(QApplication::translate("SponsorMainWindowFr", "etat contrat", Q_NULLPTR));
        label_41->setText(QApplication::translate("SponsorMainWindowFr", "nom", Q_NULLPTR));
        tempsaffichage_lineEdit_2->setText(QApplication::translate("SponsorMainWindowFr", "type here", Q_NULLPTR));
        name_lineEdit_2->setText(QApplication::translate("SponsorMainWindowFr", "type here", Q_NULLPTR));
        label_42->setText(QApplication::translate("SponsorMainWindowFr", "montant", Q_NULLPTR));
        nb_totalaffichage_lineEdit_2->setText(QApplication::translate("SponsorMainWindowFr", "type here", Q_NULLPTR));
        id_lineEdit_2->setText(QApplication::translate("SponsorMainWindowFr", "type here", Q_NULLPTR));
        ajouter_2->setText(QApplication::translate("SponsorMainWindowFr", "Ajouter", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_4), QApplication::translate("SponsorMainWindowFr", "Mise a ajour", Q_NULLPTR));
        label_35->setText(QApplication::translate("SponsorMainWindowFr", "ID", Q_NULLPTR));
        id_lineEdit_delete->setText(QApplication::translate("SponsorMainWindowFr", "ecrire ici", Q_NULLPTR));
        delete_button->setText(QApplication::translate("SponsorMainWindowFr", "Delete", Q_NULLPTR));
        label_38->setText(QApplication::translate("SponsorMainWindowFr", "taper l'id de sponsor", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("SponsorMainWindowFr", "Supprimer", Q_NULLPTR));
        clear_all_in_table->setText(QApplication::translate("SponsorMainWindowFr", "supprimer tout les sponsors", Q_NULLPTR));
        list_all_button->setText(QApplication::translate("SponsorMainWindowFr", "sponsor list", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("SponsorMainWindowFr", "affichage", Q_NULLPTR));
        label_48->setText(QApplication::translate("SponsorMainWindowFr", "debut", Q_NULLPTR));
        label_49->setText(QApplication::translate("SponsorMainWindowFr", "fin", Q_NULLPTR));
        SendButton->setText(QApplication::translate("SponsorMainWindowFr", "sauvegarder", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_16), QApplication::translate("SponsorMainWindowFr", "Calendrier", Q_NULLPTR));
        jgcugedu->setText(QApplication::translate("SponsorMainWindowFr", "contrats", Q_NULLPTR));
        sms->setText(QApplication::translate("SponsorMainWindowFr", "envoyer sms", Q_NULLPTR));
        excel->setText(QApplication::translate("SponsorMainWindowFr", "Generer excel", Q_NULLPTR));
        sortComboBox->clear();
        sortComboBox->insertItems(0, QStringList()
         << QApplication::translate("SponsorMainWindowFr", "default", Q_NULLPTR)
         << QApplication::translate("SponsorMainWindowFr", "A-Z", Q_NULLPTR)
        );
        eng->setText(QApplication::translate("SponsorMainWindowFr", "ENG", Q_NULLPTR));
        ...
        pushButton_7->setText(QApplication::translate("SponsorMainWindowFr", "se deconnecter", Q_NULLPTR));
        label_13->setText(QApplication::translate("SponsorMainWindowFr", "Employees", Q_NULLPTR));
        menuCreate->setTitle(QApplication::translate("SponsorMainWindowFr", "Create ", Q_NULLPTR));
        menuRead->setTitle(QApplication::translate("SponsorMainWindowFr", "Read", Q_NULLPTR));
        menuupdate->setTitle(QApplication::translate("SponsorMainWindowFr", "Update", Q_NULLPTR));
        menudelete->setTitle(QApplication::translate("SponsorMainWindowFr", "Delete ", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class SponsorMainWindowFr: public Ui_SponsorMainWindowFr {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_SPONSORMAINWINDOW_FR_H
