...
EmissionMainWindowDarkMode::EmissionMainWindowDarkMode(QWidget *parent)
    : QMainWindow(parent)
    , ui(new Ui::EmissionMainWindowDarkMode)
{
    ui->setupUi(this);


    // Connect dark mode button signal to slot
    connect(ui->sortComboBox, QOverload<const QString &>::of(&QComboBox::currentIndexChanged), this, &EmissionMainWindowDarkMode::on_Sort_clicked);


}

EmissionMainWindowDarkMode::~EmissionMainWindowDarkMode()
{
    delete ui;
}

// Slot for dark mode button clicked
void EmissionMainWindowDarkMode::on_dark_mode_clicked()
{
...
void EmissionMainWindowDarkMode::on_ajouter_clicked()
{
...
void EmissionMainWindowDarkMode::on_delete_button_clicked()
{
...
//void EmissionMainWindowDarkMode::on_list_all_button_clicked()
//{
//    ui->tabb->setModel(Emission.ReadEmission());
//}
...
void EmissionMainWindowDarkMode::on_clear_all_in_table_clicked()
{
...
void EmissionMainWindowDarkMode::on_update_clicked()
{
...
void EmissionMainWindowDarkMode::on_stat_clicked()
{
    EMISSION emission;
...
//pdf//////////////////
void EmissionMainWindowDarkMode::on_Generate_PDF_clicked()
{
...
/*
void EmissionMainWindowDarkMode::on_printEmissions_clicked()
{
...
//excel///////////:::
void EmissionMainWindowDarkMode::on_excel_clicked() {
...
QStringList EmissionMainWindowDarkMode::readEmissionForExcel(const QSqlQueryModel* model, int row) {
    QStringList rowData;
    const int columnCount = model->columnCount();
...
void EmissionMainWindowDarkMode::on_Sort_clicked()
{
...
void EmissionMainWindowDarkMode::on_generateQRButton_clicked()
{
    // PDF download link
